...
const TerminalComponent = () => {
  ...
  const executeCommand = (command) => {
    switch (command.trim()) {
      case 'help':
        terminal.current.write('\x1b[36mAvailable commands: intro, techstack, contact, clear, projects, education\x1b[0m\r\n'); // Cyan text
        break;
      case 'intro':
        terminal.current.write('\x1b[33mHello! I am a Web2.0 + Web3.0 developer. I love to build robust and scalable applications.\x1b[0m\r\n'); // Yellow text
        break;
      case 'techstack':
        terminal.current.write('\x1b[35mI am proficient in React, Node.js, Express.js, MongoDB, and Solidity.\x1b[0m\r\n'); // Magenta text
        break;
      case 'contact':
        terminal.current.write('\x1b[34mYou can reach me at supersen@gmail.com\x1b[0m\r\n'); // Blue text
        break;
      case 'projects':
